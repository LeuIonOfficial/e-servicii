export const WelcomePage = () => {
  return (
    <div
      id="part-1"
      className="relative flex justify-center h-[calc(100vh-50px)] flex-col-reverse px-4 py-16 mx-auto lg:block lg:flex-col lg:py-32 xl:py-48 md:px-8 sm:max-w-xl md:max-w-full"
    >
